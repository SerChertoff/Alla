...
export const siteUrl = trimSlash(
  import.meta.env.VITE_SITE_URL?.trim() || "https://chernova.ru"
);

export const contactEmail =
  import.meta.env.VITE_CONTACT_EMAIL?.trim() || "office@alla-chernova.ru";

export const site = {
  lawyerName: "Чернова Алла Владимировна",
  ...
  telegram: "https://t.me/alla_chernova_lawyer",
  mapEmbedUrl:
